...
const SignUp: React.FC = () => {
  const [showBackLogon, setShowBackLogon] = useState(true);
  ...
  const keyboardDidShow = (): void => {
    setShowBackLogon(false);
  };

  const keyboardDidHide = () => {
    setShowBackLogon(true);
  };
  ...
  const handleSignUp = useCallback(async (data: SignUpFormData) => {
    try {
      ...
      Alert.alert(
        'Erro ao criar conta',
        'Ocorreu um erro na criacao de conta, verifique suas credenciais.',
      );
    }
  }, []);
